...
export default function HomePage() {
  return (
    <div className="flex flex-col bg-slate-50">
      {/* Mobile Header */}
      <header className="sticky top-0 z-40 bg-slate-50/80 px-4 py-3 backdrop-blur md:hidden">
        <div className="flex items-center justify-between">
          <h1 className="text-lg font-bold text-slate-800">CCA Education Agency</h1>
        </div>
      </header>
            ...
            <div className="container-custom">
              <div className="text-center max-w-4xl mx-auto">
                ...
                <p className="text-base text-gray-600 mb-6 leading-relaxed px-4 md:text-lg md:mb-8">
                  전 세계 선도적인 교육 기관과 함께 여러분의 꾸을 이룰 수 있도록 도와드립니다. 지원부터 졸업까지 전방위에 걸쳐 포괄적인 지원을 제공합니다.
                </p>
      ...
      <main className="md:hidden flex-1">
        <section className="px-4 pt-2">
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
            <MenuCard title="Language School" subtitle="어학원 과정" href="/language-institutes" tone="green"  badge="NEW" />
            <MenuCard title="University" subtitle="대학교 입학" href="/universities" tone="purple" />
            <MenuCard title="Graduate" subtitle="대학원 입학" href="/graduate-schools" tone="blue" />
            <MenuCard title="Korean Lessons" subtitle="한국어 과정" href="/korean-courses" tone="orange" />
            <MenuCard title="About" subtitle="About CCA" href="/agency-info" tone="red" />
          </div>
        </section>
